...
namespace Microsoft.BotBuilderSamples
{
    ...
    public class SimpleGraphClient
    {
        ...
        public async Task<User> GetUserAsync(string upn)
        {
            //NO RIGHTS AVAILABLE IN DEMO
            var graphClient = GetAuthenticatedClient();
            var user = await graphClient.Users[upn].Request().Select(u => new
            {
                u.DisplayName,
                u.JobTitle,
                u.Department,
        ...
        public async Task RemoveUserAsync(string upn)
        {
            //NO RIGHTS AVAILABLE IN DEMO
            var graphClient = GetAuthenticatedClient();
            await graphClient.Users["upn"].Request().DeleteAsync();
        }

        public async Task DisableUserAsync(string upn)
        {
            //NO RIGHTS AVAILABLE IN DEMO
            var user = new User
            {
            ...
            await graphClient.Users[upn].Request().UpdateAsync(user);
        }

        public async Task EnableUserAsync(string upn)
        {
            //NO RIGHTS AVAILABLE IN DEMO
            var user = new User
            {
